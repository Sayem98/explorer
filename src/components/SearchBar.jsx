...
function SearchBar() {
  return (
    <div className="w-full h-[200px] bg-[#1f2937] px-6 py-8">
      <div className="max-w-[1400px] w-full mx-auto px-6 space-y-3">
        <h2 className="text-lg text-white font-semibold">
          AES Blockchain Explorer
        </h2>
        <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg w-[70%]">
          <select className="focus:outline-none w-[7rem]">
